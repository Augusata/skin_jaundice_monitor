...
avg_colory05=avg_colory05-yellow05;
avg_colory15=avg_colory15-yellow15;



y05=sum(avg_colory05(1:2));
y1=sum(avg_colory1(1:2));
y15=sum(avg_colory15(1:2));
y2=sum(avg_colory2(1:2));
y25=sum(avg_colory25(1:2));
y3=sum(avg_colory3(1:2));
y35=sum(avg_colory35(1:2));
y4=sum(avg_colory4(1:2));



yellows = [y05 y1 y15 y2 y25 y3 y35 y4];
tarlvl =[0.5 1 1.5 2 2.5 3 3.5 4];

figure(3);
hold on
plot(tarlvl, yellows, LineWidth=2);
plot(tarlvl, yellows, '.', 'Color','k','MarkerSize',15);
